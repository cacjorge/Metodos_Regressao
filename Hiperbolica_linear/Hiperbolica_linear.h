/*
 * Hiperbolica_linear.h
 *
 *  Created on: 14/01/2010
 *      Author: Carlos Antonio
 */

#ifndef Hiperbolica_linear_H_
#define Hiperbolica_linear_H_
...
public:
	...
	void executa();
	double Tempo_Execucao(void(Hiperbolica_linear::*function)(void));
	virtual ~Hiperbolica_linear();
};

#endif /* Hiperbolica_linear_H_ */
