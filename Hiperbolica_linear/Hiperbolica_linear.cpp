...
Hiperbolica_linear::Hiperbolica_linear(string nomeArquivo):a(0.1)
{
...
Hiperbolica_linear::~Hiperbolica_linear()
{

}

bool Hiperbolica_linear::lerDados()
{
...
void Hiperbolica_linear::gerDIFFA(VetorDados x,long double a,long double b)
{
	diffA.clear();
...
void Hiperbolica_linear::gerDIFFB(VetorDados x,long double a,long double b)
{
	diffB.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
void Hiperbolica_linear::gerF(VetorDados x,long double a,long double b)
{
	dadosF.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
Matriz *Hiperbolica_linear::montaZ() throw(int)
{
...
VetorDados Hiperbolica_linear::setErro(VetorDados x,VetorDados y)
{
	VetorDados temp;
...
void Hiperbolica_linear::executa()
{
	VetorDados I(2,0);
	int cont=0;
	do{
...
double Hiperbolica_linear::Tempo_Execucao(void(Hiperbolica_linear::*function)(void))
	{
