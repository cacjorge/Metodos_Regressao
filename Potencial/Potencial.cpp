...
Potencial::Potencial(string nomeArquivo):a(0.1)
{
...
void Potencial::gerDIFFA(VetorDados x,long double a,long double b)
{
	diffA.clear();
...
void Potencial::gerDIFFB(VetorDados x,long double a,long double b)
{
	diffB.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
void Potencial::gerF(VetorDados x,long double a,long double b)
{
	dadosF.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
Matriz *Potencial::montaZ() throw(int)
{
...
VetorDados Potencial::setErro(VetorDados x,VetorDados y)
{
	VetorDados temp;
...
double Potencial::Tempo_Execucao(void(Potencial::*function)(void))
	{
