...
Linear::Linear(string nomeArquivo):a(0.1),c(1.0)
{
...
void Linear::gerDIFFA(VetorDados x,long double a,long double b)
{
	diffA.clear();
...
void Linear::gerDIFFB(VetorDados x,long double a,long double b)
{
	diffB.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
void Linear::gerF(VetorDados x,long double a,long double b)
{
	dadosF.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
Matriz *Linear::montaZ() throw(int)
{
...
VetorDados Linear::setErro(VetorDados x,VetorDados y)
{
	VetorDados temp;
...
double Linear::Tempo_Execucao(void(Linear::*function)(void))
	{
