...
Exponencial::Exponencial(string nomeArquivo):a(0.1)
{
...
void Exponencial::gerDIFFA(VetorDados x,long double a,long double b)
{
	diffA.clear();
...
void Exponencial::gerDIFFB(VetorDados x,long double a,long double b)
{
	diffB.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
void Exponencial::gerF(VetorDados x,long double a,long double b)
{
	dadosF.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
Matriz *Exponencial::montaZ() throw(int)
{
...
VetorDados Exponencial::setErro(VetorDados x,VetorDados y)
{
	VetorDados temp;
...
double Exponencial::Tempo_Execucao(void(Exponencial::*function)(void))
	{
