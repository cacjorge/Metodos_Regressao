...
Hill::Hill(string nomeArquivo):a(0.1),b(0.1)
{
...
void Hill::gerDIFFA(VetorDados x,long double a,long double b)
{
	diffA.clear();
...
void Hill::gerDIFFB(VetorDados x,long double a,long double b)
{
	diffB.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
void Hill::gerF(VetorDados x,long double a,long double b)
{
	dadosF.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
VetorDados Hill::setErro(VetorDados x,VetorDados y)
{
	VetorDados temp;
...
double Hill::Tempo_Execucao(void(Hill::*function)(void))
	{
