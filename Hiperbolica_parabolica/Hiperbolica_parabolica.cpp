...
Hiperbolica_parabolica::Hiperbolica_parabolica(string nomeArquivo):a(0.1)
{
...
Hiperbolica_parabolica::~Hiperbolica_parabolica()
{

}

bool Hiperbolica_parabolica::lerDados()
{
...
void Hiperbolica_parabolica::gerDIFFA(VetorDados x,long double a,long double b)
{
	diffA.clear();
...
void Hiperbolica_parabolica::gerDIFFB(VetorDados x,long double a,long double b)
{
	diffB.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
void Hiperbolica_parabolica::gerF(VetorDados x,long double a,long double b)
{
	dadosF.clear();
	for(unsigned int pos=0;pos<x.size()-1;pos++)
	{
...
Matriz *Hiperbolica_parabolica::montaZ() throw(int)
{
...
VetorDados Hiperbolica_parabolica::setErro(VetorDados x,VetorDados y)
{
	VetorDados temp;
...
void Hiperbolica_parabolica::executa()
{
	VetorDados I(2,0);
	int cont=0;
	do{
...
double Hiperbolica_parabolica::Tempo_Execucao(void(Hiperbolica_parabolica::*function)(void))
	{
